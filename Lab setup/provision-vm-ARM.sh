...
wget https://github.com/docker/buildx/releases/download/$VERSION/buildx-$VERSION.linux-arm64 -O $HOME/.docker/cli-plugins/docker-buildx
...
mkdir ${HOME}/nessus
curl --request GET --url "https://raw.githubusercontent.com/unixerius/DSO/main/Nessus/nessus-docker-arm" --output "${HOME}/nessus/nessus-docker-arm"
docker build -t nessus -f ${HOME}/nessus/nessus-docker-arm ${HOME}/nessus/
